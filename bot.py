...
token = '5718397666:AAEiLlErT_YYi67sc-oskq6WWDo1hm5cNeo'
...
def help(message):
    bot.send_message(message.chat.id,
                     ' /Switch_Week_even - переключить неделю на четную \n /Switch_Week переключить неделю на нечетную \n /mtuci - Сайт университета \n Далее запросы удобно выбираются с помощью плиток. Если у вас пропали плитки просто смените неделю. Приятного пользования, также не забывайте проверять актуальность рассписания на сайте: https://mtuci.ru/')
...
def Switch_Week(message):
    ...
    btn8 = types.KeyboardButton("Help")
    markup.add(btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8)
    bot.send_message(message.chat.id, text="Уважаемый {0.first_name}! Вы переключились на нечетную неделю!".format(
        message.from_user), reply_markup=markup)
...
def start(message):
    ...
    markup.add(btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8)
    bot.send_message(message.chat.id,
                     text="Уважаемый {0.first_name}! Вы переключились на четную неделю!".format(message.from_user),
                     reply_markup=markup)
...
def func(message):
    if (message.text == "Switch_Week"):
        ...
        markup.add(btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8)
        bot.send_message(message.chat.id,
                         text="Уважаемый {0.first_name}! Вы переключились на нечетную неделю!".format(
                             message.from_user), reply_markup=markup)
        ...
        btn8 = types.KeyboardButton("Help")
        markup.add(btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8)
        bot.send_message(message.chat.id, text="Нечетный понедельник".format(message.from_user), reply_markup=markup)
        bot.send_message(message.chat.id,
                         text="Предмет | Кабинет | Время | Преподаватель \n Высш.мат.(л) | Н-526 | 9:30 | Пискарев С.И \n ВВИТ(пр) | Н-324 | 11:20 | Колесников О.В. \n ВВИТ(пр) | Н-324 | 13:10 | Колесников О.В.),".format(
                             message.from_user), reply_markup=markup)
        ...
        bot.send_message(message.chat.id,
                         text="Предмет | Кабинет | Время | Преподаватель \n Высш.мат.(пр) | Н-526 | 9:30 | Пискарев С.И \n Физ-культура(пр) | Н-С/Зал-2 | 11:20 | Волохова С.В. \n Иностранный язык(пр) | Н-420 | 13:10 | Мальцева С.Н.".format(
                             message.from_user), reply_markup=markup)
        ...
        btn8 = types.KeyboardButton("Help")
        markup.add(btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8)
        bot.send_message(message.chat.id, text="Нечетный четверг".format(message.from_user), reply_markup=markup)
        bot.send_message(message.chat.id,
        ...
        bot.send_message(message.chat.id,
                         ' /Switch_Week_even - переключить неделю на четную \n /Switch_Week переключить неделю на нечетную \n /mtuci - Сайт университета \n Далее запросы выбираются спомощью плиток, что достаточно удобно. Если у вас пропали плитки просто смените неделю. Приятного пользования, также не забывайте проверять актуальность рассписания на сайте: https://mtuci.ru/')
        ...
        btn8 = types.KeyboardButton("Help")
        markup.add(btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8)
        bot.send_message(message.chat.id, text="Четный понедельник".format(message.from_user), reply_markup=markup)
        bot.send_message(message.chat.id,
                         text="Предмет | Кабинет | Время | Преподаватель \n Физика(л) | Н-226 | 9:30 | Карпов И.А. \n Высш.мат.(л) | Н-514 | 11:20 | Пискарев С.И \n Иностранный язык(пр) | Н-328 | 13:10 | Мальцева С.Н. \n История(пр) | Н-401 | 15:25 | Скляр Л.Н.".format(
                             message.from_user), reply_markup=markup)
